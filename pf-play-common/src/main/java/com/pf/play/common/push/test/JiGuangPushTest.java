package com.pf.play.common.push.test;
...
import com.pf.play.common.push.common.AppPushManger;
import com.pf.play.common.push.enumClass.PlatFormEnum;
...
//		appPushParam.setMessage("测试信息");
		appPushParam.setMessage("Hello World!");
		appPushParam.setMessage("小龙测试!");
 		//推动的自定义信息
		...
		boolean flag = manger.push(appPushParam);
