...
//        A00002("A00002", "客户端传的appKey为空!"),
        ...
        D00022("D00022", "错误,请重试!", "获取已超时订单详情时,所有数据都为空!"),
        D00023("D00023", "错误,请重试!", "获取已超时订单详情时,订单号数据为空!"),
        D00024("D00024", "错误,请重试!", "获取已超时订单详情时,订单类型数据为空!"),
        D00025("D00025", "错误,请重试!", "获取已超时订单列表时,所有数据都为空!"),
        D00026("D00026", "错误,请重试!", "获取订单详情时,根据用户ID查询用户数据为空!"),
        ...
        T00030("T00030", "用户必须得打赏过,才能进行交易!", "卖家没有打赏过,所以无法进行交易!"),
        T00031("T00031", "订单已被其它卖家捷足先登,请选择其它订单!", "卖家在卖给买家订单时,根据订单交易状态已经处于锁定状态!"),

        /***********************************************
         * U调用关于阿里云的错误
         **********************************************/
        U00001("U00001", "错误,请重试!", "阿里支付:生成订单码时,所有数据都为空!"),
        U00002("U00002", "错误,请重试!", "查询阿里支付默认策略金额数据为空!"),
        U00003("U00003", "错误,请重试!", "查询阿里支付默认策略金额的具体金额数据为空!"),
        U00004("U00004", "错误,请重试!", "从阿里支付宝获取的订单数据为空!"),
        U00005("U00005", "阿里支付订单结果返回解析数据为空!", "阿里支付订单结果返回解析数据为空!"),
